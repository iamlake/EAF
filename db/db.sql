...
prompt Created on 2017年12月18日 by icelake
set feedback off
set define off
...
values ('admin', 'admin', '1', '系统管理员', 'sys', null, 'F', null, 'assets/images/userhead/icelake.jpg', null, null, null, null, null, null, null, null, '1', 'admin', null, null, null, null, null, null);
insert into SYS_ORG_USER (user_id, account, password, fullname, user_type, pwd_changed_time, is_locked, locked_reason, user_head, sex, birthdate, mobile_telephone, email, credentials_type, credentials_number, home_address, remark, active_flag, created_by, creation_time, modified_by, modification_time, ext1, ext2, ext3)
values ('boa', 'boa', '102526', '沈璐', 'user', null, 'F', null, 'assets/images/userhead/boa.jpg', null, null, null, null, null, null, null, null, '1', 'admin', null, null, null, null, null, null);
commit;
prompt 2 records loaded
